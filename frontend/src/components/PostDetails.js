...
import { fetchPostDetails, fetchComments, editPost, upVotePost, downVotePost, deletePost } from '../actions';
...
export default connect(
    mapStateToProps,
    { fetchPostDetails, fetchComments, editPost, upVotePost, downVotePost, deletePost }
)(PostDetails);